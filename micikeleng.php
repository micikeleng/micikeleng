...
<body>
    <div class="menu-header">
        <ul>
            ...
            <li><i class="fa-brands fa-github"></i>&nbsp;nanti kita buat di github ygy wkwk</li>
            <li class="logo-gecko"><img width="400" height="400" src="https://zhyper-shel.info/imgzhyper/tol.png" align="right"></li>
